...
public class HBaseMetadataProviderTest {
  ...
  public void testBasic() {
    ...
    ColumnMappingDescriptor columnMapping = desc.getColumnMappingDescriptor();
  ...
  public void testOverride() {
    ...
    DatasetDescriptor desc = provider.create(
        tableName + ".AlternateTestEntity", new DatasetDescriptor.Builder()
            ...
            .columnMappingDescriptor(columnMappingIn).build());
    ...
    assertEquals("alt:field1", columnMapping.getFieldMapping("field1")
        .getMappingValue());
    assertEquals("altstring:", columnMapping.getFieldMapping("field3")
        .getMappingValue());
    assertEquals(MappingType.COLUMN, columnMapping.getFieldMapping("field4")
        .getMappingType());
  }
}
